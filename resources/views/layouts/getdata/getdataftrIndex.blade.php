...
<div class="container-fluid">
    ...
    <form action="{{ URL::asset('/getdata_ftr/periode') }}" method="POST">
        @csrf
        <div class="row">
            <div class="form-group ml-2">
                ...
                <button type="button" class="btn bg-maroon mb-2 btn-block" data-toggle="modal"
                    ...
                    <i class="fa fa-hand-o-up"></i> Rekap Data FTR
                </button>
            </div>
            <div class="form-group ml-2">
        ...
        <table class="table table-bordered table-hover table-striped" id="myTable">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $value['jml_lembar_ftr'] }}</td>
                    <td>{{number_format($value['jml_amount_ftr'],0,',')}}</td>
                </tr>
                @endforeach
            </tbody>
        </table>
        ...
        <div class="modal-body">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form action="{{ URL::asset('/getdata_ftr/proses_compare') }}" method="POST"
                        id="proses_compare">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
