        ...
        <form action="{{ URL::asset('/complain/periode') }}" method="POST" id="complainForm">
            ...
            <div class="row">
                ...
                <div class="form-group ml-2">
                    ...
                    <input type="date" id="startDate" name="startDate" class="form-control" placeholder="First Date" value="{{$first_date}}">
                </div>
                <div class="form-group ml-2">
                    <label for="endDate">End Date:</label>
                    <input type="date" id="endDate" name="endDate" class="form-control" placeholder="Last Date" value="{{$last_date}}">
                </div>
                <div class="form-group ml-2">
                ...
                <div class="form-group ml-2">
                    ...
                    <select id="klasifikasi" name="klasifikasi" class="form-control" required>
                        ...
                        <option value="all" {{ $klasifikasi == 'all' ? 'selected' : ''}}>All</option>
                        @foreach ($dataKlasifikasi as $value )
                            <option value="{{ $value['klasifikasi_complain'] }}" {{ $klasifikasi == $value['klasifikasi_complain'] ? 'selected' : '' }}>{{ $value['klasifikasi_complain'] }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="form-group ml-2">
                ...
                <div class="form-group ml-2">
                    <label>&nbsp;</label>
                    <form action="{{ URL::asset('/complain/download') }}" method="POST" autocomplete="off">
                        @csrf
                        <input type="hidden" name="start_print" value="{{$first_date}}">
                        <input type="hidden" name="end_print" value="{{$last_date}}">
                        <input type="hidden" name="kategori_print" value="{{$kategori}}">
                        <input type="hidden" name="status_print" value="{{$status}}">     
                        <input type="hidden" name="klasifikasi_print" value="{{$klasifikasi}}">        
